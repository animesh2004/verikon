...
export default function CTA() {
  ...
  return (
    <section id="contact" className="py-28 md:py-32 border-t border-[#1a1a1a]">
      <div className="container-px mx-auto max-w-7xl">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0a0b0d] to-[#090A0C] text-white p-10 md:p-16 lg:p-20 border border-[#1a1a1a]"
        >
          <div className="absolute inset-0 grid-bg opacity-[0.08]" aria-hidden="true" />
          <div
            className="absolute -top-32 -right-32 size-[35rem] rounded-full bg-[#FF6B35]/25 blur-[100px] pointer-events-none"
            aria-hidden="true"
          />
          <div className="absolute -bottom-24 -left-24 size-[30rem] rounded-full bg-[#2563EB]/20 blur-[100px] pointer-events-none" aria-hidden="true" />
          <div className="relative max-w-3xl">
            <h2 className="font-display font-bold tracking-tightest text-5xl md:text-6xl leading-[1.02] text-balance">
              Let's build something intelligent together.
            </h2>
            <p className="mt-6 text-lg md:text-xl text-[#AAAAAA] max-w-xl leading-relaxed">
